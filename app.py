...
st.markdown("""
    <style>
    /* تفعيل اتجاه لغة الضاد وإلغاء المسافات العلوية الافتراضية لـ Streamlit */
    .block-container {
...
# 3. الترويسة: تمطيط الشعار يميناً ويساراً كشريط ممتد وإلغاء المسافات قبله وبعده تماماً
st.markdown("""
    <div style="text-align: center; margin: 0 px; padding: 0 px; width: 100%;">
        <img src="https://raw.githubusercontent.com/mounir-rachdi1980/quran_project/main/logo.jpg" 
             style="display: block; width: 100%; max-width: 100%; height: 120px; object-fit: fill; margin: 0 auto; padding: 0; filter: brightness(1.25);">
        <h1 class="main-title" style="margin-top: 10px; margin-bottom: 20px;">نظام الفرع المحلي للرابطة الوطنية للقرآن الكريم بالمكناسي</h1>
    </div>
""", unsafe_allow_html=True)
