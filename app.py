...
st.markdown("""
    ...
    h1 { 
        color: #FF4D4D !important; /* 🔴 اللون الأحمر الفاتح والزاهي للعنوان الرئيسي */
        text-align: center !important;
        font-family: 'Cairo', sans-serif;
        font-weight: bold;
    } 
    h2 { 
        color: #27AE60 !important; /* أخضر زاهي موحد لعناوين الأقسام والاستمارات */
        text-align: center !important;
    } 
    h3 { 
        color: #2980B9 !important; /* أزرق مشرق موحد للقوائم والبيانات الصغرى */
    } 
    h4 { 
        color: #2980B9 !important; /* توحيد العناوين الصغرى بنفس اللون الأزرق المشرق */
    }
    </style>
...
# عرض الشعار في الوسط والأعلى مباشرة
try:
...
st.markdown("<h1 style='margin-top: 20px; margin-bottom: 25px;'>نظام الفرع المحلي للرابطة الوطنية للقرآن الكريم بالمكناسي</h1>", unsafe_allow_html=True)
...
# --- تسجيل طالب جديد ---
    ...
    st.markdown("<h2>📝 استمارة بطاقة إرشادات طالب جديد</h2>", unsafe_allow_html=True)
    ...
    st.markdown("<h3>👥 قائمة الطلاب المسجلين حالياً :</h3>", unsafe_allow_html=True)
    ...
    if st.session_state.students_db.empty:
        ...
        <div style="border: 3px double #FF4D4D; padding: 25px; border-radius: 10px; background-color: #FAFAFA; direction: rtl; font-family: 'Cairo', sans-serif; text-align: right; margin: 0 auto; max-width: 900px;">
            <div style="text-align: center;">
                <h2 style="margin: 0; color: #FF4D4D;">بطاقة تقييم وكشف أعداد طالب سنوي</h2>
